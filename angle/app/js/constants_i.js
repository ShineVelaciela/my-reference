...
const img_r_url = environment + '/mzkimg/';  //图片服务器
/*改变数据状态*/
 ...
 */
/*git获取用户*/
const git_api = 'http://i.karakal.com.cn:18089/git/api/v3/';
...
const git_user_url = "http://i.karakal.com.cn:18089/git/api/v3/";
/*git获取全部用户*/
 ...
 * ------------------------
 */
const MDPFACE_URL = 'http://temp.karakal.com.cn:18089' + '/mdpface/api/1/';
